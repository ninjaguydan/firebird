...
const SvgSuccess = ({ fill = "black", className = "" }: SVGProps<SVGSVGElement>) => (
  <svg
    className={className}
    width="24"
    height="24"
